...
export default function Services({ onApplyQuoteToForm }: ServicesProps) {
  ...
  return (
    <section id="servicios" className="py-24 md:py-32 bg-[#0b1326] relative overflow-hidden">
      ...
      <div className="px-6 md:px-20 max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <div className="h-1.5 w-16 bg-[#00f0ff] mx-auto rounded-full" />
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-16">
          <button
            ...
            className="px-6 py-3.5 bg-[#00f0ff] text-[#002022] font-sans text-xs font-bold uppercase tracking-wider rounded-md hover:shadow-[0_0_20px_rgba(0,240,255,0.4)] transition-all cursor-pointer flex items-center gap-2"
          >
          ...
          <button
            ...
            className="px-6 py-3.5 bg-[#171f33] border border-white/10 text-white font-sans text-xs font-bold uppercase tracking-wider rounded-md hover:bg-white/5 transition-all cursor-pointer flex items-center gap-2"
          >
          ...
          {capabilitiesData.map((cap, idx) => {
            return (
              <motion.div
                ...
                className="group p-6 md:p-8 rounded-xl bg-[#131b2e]/60 border border-white/5 backdrop-blur-sm cursor-pointer hover:border-[#00f0ff]/30 hover:bg-[#131b2e]/80 transition-all flex flex-col justify-between"
              >
                <div>
                  {/* Icon of Capability */}
                  <div className="h-12 w-12 rounded-lg bg-[#171f33] border border-white/10 flex items-center justify-center text-[#00f0ff] group-hover:bg-[#00f0ff]/10 group-hover:border-[#00f0ff]/20 transition-all shadow-md mb-6">
                    <CapabilityIcon name={cap.iconName} className="h-6 w-6" />
                  </div>

                  {/* Title and brief description */}
                  <h3 className="font-display text-lg font-bold text-[#dbfcff] group-hover:text-[#00f0ff] transition-colors mb-2 flex items-center justify-between">
                    <span>{cap.title}</span>
                    <ChevronRight className="h-4 w-4 text-white/20 group-hover:text-[#00f0ff] group-hover:translate-x-1 transition-all" />
                  </h3>
                  
                  <p className="font-sans text-xs text-[#b9cacb] leading-relaxed mb-6 font-medium">
                    {cap.description}
                  </p>
                </div>
                ...
                <div className="flex flex-wrap gap-1.5 pt-4 border-t border-white/5">
                  {cap.typicalStack.slice(0, 3).map((item) => (
                    <span
                      key={item}
                      className="font-mono text-[9px] font-semibold text-[#b9cacb]/80 bg-white/[0.03] px-2 py-0.5 rounded uppercase"
                    >
                      {item}
                    </span>
                  ))}
                  {cap.typicalStack.length > 3 && (
                    <span className="font-mono text-[9px] font-semibold text-[#00f0ff] bg-[#00f0ff]/5 px-1.5 py-0.5 rounded">
                      +{cap.typicalStack.length - 3}
                    </span>
                  )}
                </div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative rounded-2xl bg-gradient-to-r from-[#131b2e] via-[#17253f] to-[#131b2e] p-8 md:p-14 border border-white/10 text-center overflow-hidden shadow-2xl"
        >
          <div className="absolute inset-0 bg-[#00f0ff]/5 blur-3xl rounded-full w-96 h-96 -top-1/2 left-1/2 -translate-x-1/2 pointer-events-none" />

          <span className="text-[10px] font-bold uppercase tracking-widest text-[#00f0ff] mb-4.5 block uppercase">
            Estudios de Viabilidad
          </span>
          <h3 className="font-display text-2xl md:text-3xl font-extrabold text-white mb-6 max-w-2xl mx-auto leading-snug">
            ¿Listo para una actualización sistémica de tu software actual o lanzar una idea nueva?
          </h3>
          <p className="font-sans text-sm text-[#b9cacb] max-w-xl mx-auto mb-10">
          ...
          <button
            ...
            className="font-sans text-xs font-bold uppercase tracking-widest bg-[#00f0ff] text-[#002022] px-8 py-4 rounded-md hover:scale-[1.03] hover:shadow-[0_0_25px_rgba(0,240,255,0.4)] transition-all cursor-pointer flex items-center gap-2.5 mx-auto"
          >
        ...
        {isMethodologyOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-[#131b2e] border border-white/10 rounded-xl w-full max-w-3xl overflow-hidden shadow-2xl z-10 text-[#dae2fd]"
            >
              <div className="p-6 border-b border-white/10 flex justify-between items-center bg-[#0b1326]">
                <div className="flex items-center gap-2">
                  <Compass className="h-5 w-5 text-[#00f0ff]" />
                ...
                <button
                  onClick={() => setIsMethodologyOpen(false)}
                  className="p-1.5 rounded-full hover:bg-white/5 text-[#b9cacb] transition-colors cursor-pointer"
                >
                  <X className="h-5 w-5" />
                </button>
              </div>
              ...
              <div className="p-6 md:p-10 max-h-[70vh] overflow-y-auto flex flex-col gap-8">
                <p className="text-sm text-[#b9cacb] leading-relaxed font-sans mb-4">
                ...
                <div className="relative border-l border-white/10 pl-6 ml-4 flex flex-col gap-10">
                  {pipelineSteps.map((step) => (
                    <div key={step.step} className="relative">
                      ...
                      <span className="absolute -left-[35px] top-0 h-6 w-6 rounded-full bg-[#00f0ff] border-4 border-[#131b2e] flex items-center justify-center text-[10px] font-bold text-[#002022] shadow font-display">
                        {step.step}
                      </span>
              ...
              <div className="bg-[#0b1326] p-6 border-t border-white/10 flex items-center justify-end">
                <button
                  onClick={() => setIsMethodologyOpen(false)}
                  className="px-5 py-2.5 bg-[#171f33] text-white font-sans text-xs font-semibold rounded hover:bg-white/5 cursor-pointer"
                >
                  Cerrar
                </button>
              </div>
        ...
        {selectedCapDetail && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className="absolute inset-0 bg-[#060e20]/95 backdrop-blur-sm cursor-pointer"
            />
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 30 }}
              className="relative bg-[#171f33] border border-white/10 rounded-xl w-full max-w-lg p-6 md:p-8 z-10 text-[#dae2fd] shadow-2xl"
            >
              <button
                onClick={() => setSelectedCapabilityId(null)}
                className="absolute top-4 right-4 p-1.5 rounded-full hover:bg-white/5 text-[#b9cacb]"
              >
                <X className="h-5 w-5" />
              </button>

              <div className="flex items-center gap-3 mb-6">
                <div className="h-10 w-10 rounded-md bg-[#00f0ff]/10 text-[#00f0ff] flex items-center justify-center border border-[#00f0ff]/20">
                  <CapabilityIcon name={selectedCapDetail.iconName} className="h-5 w-5" />
                </div>
                <div>
                  <span className="text-[9px] uppercase tracking-widest font-bold text-white/40 font-mono">
              ...
              <p className="font-sans text-sm text-[#b9cacb]/90 leading-relaxed mb-6">
                ...
                <div>
                  ...
                  <div className="flex gap-2 flex-wrap mt-1.5">
                    {selectedCapDetail.typicalStack.map(stackItem => (
                      <span key={stackItem} className="text-xs font-semibold px-2.5 py-1 bg-white/[0.03] rounded border border-white/5 text-white">
                        {stackItem}
                      </span>
                    ))}
                  </div>
              ...
              <div className="flex gap-3 pt-4 border-t border-white/5">
                <button
                  ...
                  className="flex-1 py-3 text-center rounded bg-[#00f0ff] text-[#002022] font-semibold text-xs uppercase tracking-wider hover:bg-[#00dcf8]"
                >
